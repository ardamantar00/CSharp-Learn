...
namespace CSharpEgitimKampi601.Services
{
    public class CustomerOperations
    {
        public void AddCustomer(Customer customer)
        {
            ...
            var customerCollection = connection.GetCusomerCollection();
        ...
        public List<Customer> GetAllCustomer()
        {
            var connection = new MongoDbConnection();
            var customerCollection = connection.GetCusomerCollection();
            var customers = customerCollection.Find(new BsonDocument()).ToList(); //customers içinde MongoDB'den gelen tüm veriler var

            List<Customer> customerList = new List<Customer>(); //Bellekte boş bir Customer listesi oluşturduk
